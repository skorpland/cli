...
func TestDownloadCommand(t *testing.T) {
	...
	t.Run("throws error on missing function", func(t *testing.T) {
		...
		err = Run(context.Background(), slug, project, true, fsys)
		// Check error
		assert.ErrorContains(t, err, "Function test-func does not exist on the Powerbase project.")
	})
}
...
func TestGetMetadata(t *testing.T) {
	...
	t.Run("throws error on service unavailable", func(t *testing.T) {
		...
		meta, err := getFunctionMetadata(context.Background(), project, slug)
		// Check error
		assert.ErrorContains(t, err, "Failed to download Function test-func on the Powerbase project:")
		assert.Nil(t, meta)
	})
}
