...
import (
	...
	"github.com/skorpland/cli/internal/sso/internal/saml"
...
func Run(ctx context.Context, params RunParams) error {
	getResp, err := utils.GetPowerbase().V1GetASsoProviderWithResponse(ctx, params.ProjectRef, params.ProviderID)
	if err != nil {
	...
	putResp, err := utils.GetPowerbase().V1UpdateASsoProviderWithResponse(ctx, params.ProjectRef, params.ProviderID, body)
	if err != nil {
