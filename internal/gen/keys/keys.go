...
type CustomName struct {
	DbHost         string `env:"db.host,default=NEXT_PUBLIC_POWERBASE_URL"`
	DbPassword     string `env:"db.password,default=POWERBASE_DB_PASSWORD"`
	JWTSecret      string `env:"db.password,default=POWERBASE_AUTH_JWT_SECRET"`
	AnonKey        string `env:"auth.anon_key,default=POWERBASE_AUTH_ANON_KEY"`
	ServiceRoleKey string `env:"auth.service_role_key,default=POWERBASE_AUTH_SERVICE_ROLE_KEY"`
}
