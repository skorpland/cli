...
import (
	...
	"github.com/skorpland/cli/internal/migration/fetch"
	"github.com/skorpland/cli/internal/migration/list"
	"github.com/skorpland/cli/internal/migration/new"
	"github.com/skorpland/cli/internal/migration/repair"
	"github.com/skorpland/cli/internal/migration/squash"
	"github.com/skorpland/cli/internal/migration/up"
...
var (
	...
	migrationRepairCmd = &cobra.Command{
		...
		PostRun: func(cmd *cobra.Command, args []string) {
			fmt.Println("Finished " + utils.Aqua("powerbase migration repair") + ".")
		},
	}
	...
	migrationSquashCmd = &cobra.Command{
		...
		PostRun: func(cmd *cobra.Command, args []string) {
			fmt.Println("Finished " + utils.Aqua("powerbase migration squash") + ".")
		},
	}
