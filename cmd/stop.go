...
import (
	...
	"github.com/skorpland/cli/internal/stop"
)
...
var (
	...
	stopCmd = &cobra.Command{
		...
		Use:     "stop",
		Short:   "Stop all local Powerbase containers",
...
func init() {
	...
	flags.BoolVar(&all, "all", false, "Stop all local Powerbase instances from all projects across the machine.")
