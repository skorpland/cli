...
import (
	...
	"github.com/skorpland/cli/internal/postgresConfig/delete"
	"github.com/skorpland/cli/internal/postgresConfig/get"
	"github.com/skorpland/cli/internal/postgresConfig/update"
...
func init() {
	postgresCmd.PersistentFlags().StringVar(&flags.ProjectRef, "project-ref", "", "Project ref of the Powerbase project.")
