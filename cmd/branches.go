...
import (
	...
	"github.com/skorpland/cli/internal/branches/create"
	"github.com/skorpland/cli/internal/branches/delete"
	"github.com/skorpland/cli/internal/branches/disable"
	"github.com/skorpland/cli/internal/branches/get"
	"github.com/skorpland/cli/internal/branches/list"
	"github.com/skorpland/cli/internal/branches/update"
...
var (
	branchesCmd = &cobra.Command{
		...
		Use:     "branches",
		Short:   "Manage Powerbase preview branches",
	}
...
func init() {
	...
	branchFlags.StringVar(&flags.ProjectRef, "project-ref", "", "Project ref of the Powerbase project.")
