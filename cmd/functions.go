...
import (
	...
	"github.com/skorpland/cli/internal/functions/delete"
	"github.com/skorpland/cli/internal/functions/deploy"
	"github.com/skorpland/cli/internal/functions/download"
	"github.com/skorpland/cli/internal/functions/list"
	new_ "github.com/skorpland/cli/internal/functions/new"
...
var (
	functionsCmd = &cobra.Command{
		...
		Use:     "functions",
		Short:   "Manage Powerbase Edge functions",
	}

	functionsListCmd = &cobra.Command{
		Use:   "list",
		Short: "List all Functions in Powerbase",
		Long:  "List all Functions in the linked Powerbase project.",
	...
	functionsDeleteCmd = &cobra.Command{
		...
		Short: "Delete a Function from Powerbase",
		Long:  "Delete a Function from the linked Powerbase project. This does NOT remove the Function locally.",
	...
	functionsDownloadCmd = &cobra.Command{
		...
		Short: "Download a Function from Powerbase",
		Long:  "Download the source code for a Function from the linked Powerbase project.",
		Args:  cobra.ExactArgs(1),
		RunE: func(cmd *cobra.Command, args []string) error {
	...
	functionsDeployCmd = &cobra.Command{
		...
		Short: "Deploy a Function to Powerbase",
		Long:  "Deploy a Function to the linked Powerbase project.",
		RunE: func(cmd *cobra.Command, args []string) error {
...
func init() {
	functionsListCmd.Flags().StringVar(&flags.ProjectRef, "project-ref", "", "Project ref of the Powerbase project.")
	functionsDeleteCmd.Flags().StringVar(&flags.ProjectRef, "project-ref", "", "Project ref of the Powerbase project.")
	...
	deployFlags.StringVar(&flags.ProjectRef, "project-ref", "", "Project ref of the Powerbase project.")
	...
	functionsDownloadCmd.Flags().StringVar(&flags.ProjectRef, "project-ref", "", "Project ref of the Powerbase project.")
