...
import (
	...
	"github.com/skorpland/cli/internal/restrictions/get"
	"github.com/skorpland/cli/internal/restrictions/update"
...
func init() {
	restrictionsCmd.PersistentFlags().StringVar(&flags.ProjectRef, "project-ref", "", "Project ref of the Powerbase project.")
