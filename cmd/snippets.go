...
import (
	...
	"github.com/skorpland/cli/internal/snippets/download"
	"github.com/skorpland/cli/internal/snippets/list"
...
var (
	snippetsCmd = &cobra.Command{
		...
		Use:     "snippets",
		Short:   "Manage Powerbase SQL snippets",
	}
...
func init() {
	snippetsCmd.PersistentFlags().StringVar(&flags.ProjectRef, "project-ref", "", "Project ref of the Powerbase project.")
