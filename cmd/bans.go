...
import (
	...
	"github.com/skorpland/cli/internal/bans/get"
	"github.com/skorpland/cli/internal/bans/update"
...
func init() {
	bansCmd.PersistentFlags().StringVar(&flags.ProjectRef, "project-ref", "", "Project ref of the Powerbase project.")
