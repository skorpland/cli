...
import (
	...
	"github.com/skorpland/cli/internal/projects/delete"
	"github.com/skorpland/cli/internal/projects/list"
...
var (
	projectsCmd = &cobra.Command{
		...
		Use:     "projects",
		Short:   "Manage Powerbase projects",
	}
	...
	projectsCreateCmd = &cobra.Command{
		...
		Short:   "Create a project on Powerbase",
		Args:    cobra.MaximumNArgs(1),
		Example: `powerbase projects create my-project --org-id cool-green-pqdr0qc --db-password ******** --region us-east-1`,
	...
	projectsListCmd = &cobra.Command{
		Use:   "list",
		Short: "List all Powerbase projects",
		Long:  "List all Powerbase projects the logged-in user can access.",
		RunE: func(cmd *cobra.Command, args []string) error {
	...
	projectsApiKeysCmd = &cobra.Command{
		Use:   "api-keys",
		Short: "List all API keys for a Powerbase project",
		RunE: func(cmd *cobra.Command, args []string) error {
	...
	projectsDeleteCmd = &cobra.Command{
		Use:   "delete <ref>",
		Short: "Delete a Powerbase project",
		Args:  cobra.MaximumNArgs(1),
		PreRunE: func(cmd *cobra.Command, args []string) error {
...
func init() {
	...
	apiKeysFlags.StringVar(&flags.ProjectRef, "project-ref", "", "Project ref of the Powerbase project.")
