...
import (
	...
	"github.com/skorpland/cli/internal/ssl_enforcement/get"
	"github.com/skorpland/cli/internal/ssl_enforcement/update"
...
func init() {
	sslEnforcementCmd.PersistentFlags().StringVar(&flags.ProjectRef, "project-ref", "", "Project ref of the Powerbase project.")
