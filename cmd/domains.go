...
import (
	...
	"github.com/skorpland/cli/internal/hostnames/activate"
	"github.com/skorpland/cli/internal/hostnames/create"
	"github.com/skorpland/cli/internal/hostnames/delete"
	"github.com/skorpland/cli/internal/hostnames/get"
	"github.com/skorpland/cli/internal/hostnames/reverify"
...
var (
	customHostnamesCmd = &cobra.Command{
		...
		Use:     "domains",
		Short:   "Manage custom domain names for Powerbase projects",
		Long: `Manage custom domain names for Powerbase projects.
...
`,
	...
	customHostnamesCreateCmd = &cobra.Command{
		...
		Long: `Create a custom hostname for your Powerbase project.

Expects your custom hostname to have a CNAME record to your Powerbase project's subdomain.`,
	...
	customHostnamesGetCmd = &cobra.Command{
		...
		Long:  "Retrieve the custom hostname config for your project, as stored in the Powerbase platform.",
		RunE: func(cmd *cobra.Command, args []string) error {
...
After the custom hostname is activated, your project's auth services will no longer function on the Powerbase-provisioned subdomain.`,
		RunE: func(cmd *cobra.Command, args []string) error {
...
func init() {
	...
	customHostnamesCreateCmd.Flags().StringVar(&customHostname, "custom-hostname", "", "The custom hostname to use for your Powerbase project.")
