...
import (
	...
	"github.com/skorpland/cli/internal/db/branch/create"
	"github.com/skorpland/cli/internal/db/branch/delete"
	"github.com/skorpland/cli/internal/db/branch/list"
	"github.com/skorpland/cli/internal/db/branch/switch_"
	"github.com/skorpland/cli/internal/db/diff"
	"github.com/skorpland/cli/internal/db/dump"
	"github.com/skorpland/cli/internal/db/lint"
	"github.com/skorpland/cli/internal/db/pull"
	"github.com/skorpland/cli/internal/db/push"
	"github.com/skorpland/cli/internal/db/remote/changes"
	"github.com/skorpland/cli/internal/db/remote/commit"
	"github.com/skorpland/cli/internal/db/reset"
	"github.com/skorpland/cli/internal/db/start"
	"github.com/skorpland/cli/internal/db/test"
...
var (
	...
	dbPullCmd = &cobra.Command{
		...
		PostRun: func(cmd *cobra.Command, args []string) {
			fmt.Println("Finished " + utils.Aqua("powerbase db pull") + ".")
		},
	}
