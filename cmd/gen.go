...
import (
	...
	"github.com/skorpland/cli/internal/gen/types"
...
var (
	...
	genTypesCmd = &cobra.Command{
		...
		Example: `  powerbase gen types --local
  powerbase gen types --linked --lang=go
  powerbase gen types --project-id abc-def-123 --schema public --schema private
  powerbase gen types --db-url 'postgresql://...' --schema public --schema auth`,
	}
)
...
func init() {
	...
	keyFlags.StringVar(&flags.ProjectRef, "project-ref", "", "Project ref of the Powerbase project.")
