...
import (
	...
	"github.com/skorpland/cli/internal/vanity_subdomains/activate"
	"github.com/skorpland/cli/internal/vanity_subdomains/check"
	"github.com/skorpland/cli/internal/vanity_subdomains/delete"
	"github.com/skorpland/cli/internal/vanity_subdomains/get"
)
...
var (
	vanityCmd = &cobra.Command{
		...
		Short:   "Manage vanity subdomains for Powerbase projects",
		Long: `Manage vanity subdomains for Powerbase projects.
...
Usage of vanity subdomains and custom domains is mutually exclusive.`,
	...
	vanityActivateCmd = &cobra.Command{
		...
		Long: `Activate a vanity subdomain for your Powerbase project.

This reconfigures your Powerbase project to respond to requests on your vanity subdomain.
After the vanity subdomain is activated, your project's auth services will no longer function on the {project-ref}.{powerbase-domain} hostname.
`,
...
func init() {
	vanityCmd.PersistentFlags().StringVar(&flags.ProjectRef, "project-ref", "", "Project ref of the Powerbase project.")
	vanityActivateCmd.Flags().StringVar(&desiredSubdomain, "desired-subdomain", "", "The desired vanity subdomain to use for your Powerbase project.")
	vanityCheckCmd.Flags().StringVar(&desiredSubdomain, "desired-subdomain", "", "The desired vanity subdomain to use for your Powerbase project.")
