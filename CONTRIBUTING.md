# Welcome to Powerbase CLI contributing guide
...
3. Run the [Release (Beta)](https://github.com/skorpland/cli/actions/workflows/release-beta.yml) workflow targetting `N.N.x` branch.
4. Verify your hotfix locally with `npx powerbase@N.N.x help`
5. Edit [GitHub releases](https://github.com/skorpland/cli/releases) to set your hotfix pre-release as latest stable.
...
All new code should aim to improve [test coverage](https://coveralls.io/github/skorpland/cli).
...
- Powerbase API (via [gock](https://github.com/h2non/gock))
...
The Powerbase API client is generated from OpenAPI spec. See [our guide](api/README.md) for updating the client and types.
