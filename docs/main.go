...
import (
	...
	cli "github.com/skorpland/cli/cmd"
...
func generate(version string) error {
	...
	spec := SpecDoc{
		...
		Info: InfoDoc{
			...
			Description: forceMultiLine("Powerbase CLI provides you with tools to develop your application locally, and deploy your application to the Powerbase platform."),
			Language:    "sh",
			Source:      "https://github.com/skorpland/cli",
			Bugs:        "https://github.com/skorpland/cli/issues",
			Spec:        "https://github.com/skorpland/spec/cli_v1_commands.yaml",
			Tags:        getTags(root),
		},
	}
