...
// Defines values for PowerpoolerConfigResponseDatabaseType.
const (
	PRIMARY     PowerpoolerConfigResponseDatabaseType = "PRIMARY"
	READREPLICA PowerpoolerConfigResponseDatabaseType = "READ_REPLICA"
)

// Defines values for PowerpoolerConfigResponsePoolMode.
const (
	PowerpoolerConfigResponsePoolModeSession     PowerpoolerConfigResponsePoolMode = "session"
	PowerpoolerConfigResponsePoolModeTransaction PowerpoolerConfigResponsePoolMode = "transaction"
)
...
// Defines values for UpdatePowerpoolerConfigBodyPoolMode.
const (
	UpdatePowerpoolerConfigBodyPoolModeSession     UpdatePowerpoolerConfigBodyPoolMode = "session"
	UpdatePowerpoolerConfigBodyPoolModeTransaction UpdatePowerpoolerConfigBodyPoolMode = "transaction"
)

// Defines values for UpdatePowerpoolerConfigResponsePoolMode.
const (
	UpdatePowerpoolerConfigResponsePoolModeSession     UpdatePowerpoolerConfigResponsePoolMode = "session"
	UpdatePowerpoolerConfigResponsePoolModeTransaction UpdatePowerpoolerConfigResponsePoolMode = "transaction"
)
...
type CreateSecretBody struct {
	// Name Secret name must not start with the POWERBASE_ prefix.
	Name  string `json:"name"`
...
// PowerpoolerConfigResponse defines model for PowerpoolerConfigResponse.
type PowerpoolerConfigResponse struct {
	ConnectionString string                              `json:"connectionString"`
	DatabaseType     PowerpoolerConfigResponseDatabaseType `json:"database_type"`
	DbHost           string                              `json:"db_host"`
	...
	PoolMode         PowerpoolerConfigResponsePoolMode     `json:"pool_mode"`
}

// PowerpoolerConfigResponseDatabaseType defines model for PowerpoolerConfigResponse.DatabaseType.
type PowerpoolerConfigResponseDatabaseType string

// PowerpoolerConfigResponsePoolMode defines model for PowerpoolerConfigResponse.PoolMode.
type PowerpoolerConfigResponsePoolMode string
...
// UpdatePowerpoolerConfigBody defines model for UpdatePowerpoolerConfigBody.
type UpdatePowerpoolerConfigBody struct {
	DefaultPoolSize *int `json:"default_pool_size"`

	// PoolMode This field is deprecated and is ignored in this request
	// Deprecated:
	PoolMode *UpdatePowerpoolerConfigBodyPoolMode `json:"pool_mode,omitempty"`
}

// UpdatePowerpoolerConfigBodyPoolMode This field is deprecated and is ignored in this request
type UpdatePowerpoolerConfigBodyPoolMode string

// UpdatePowerpoolerConfigResponse defines model for UpdatePowerpoolerConfigResponse.
type UpdatePowerpoolerConfigResponse struct {
	DefaultPoolSize *int                                  `json:"default_pool_size"`
	PoolMode        UpdatePowerpoolerConfigResponsePoolMode `json:"pool_mode"`
}

// UpdatePowerpoolerConfigResponsePoolMode defines model for UpdatePowerpoolerConfigResponse.PoolMode.
type UpdatePowerpoolerConfigResponsePoolMode string
...
// V1UpdatePowerpoolerConfigJSONRequestBody defines body for V1UpdatePowerpoolerConfig for application/json ContentType.
type V1UpdatePowerpoolerConfigJSONRequestBody = UpdatePowerpoolerConfigBody
