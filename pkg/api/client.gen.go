...
type ClientInterface interface {
	...
	// V1GetPowerpoolerConfig request
	V1GetPowerpoolerConfig(ctx context.Context, ref string, reqEditors ...RequestEditorFn) (*http.Response, error)

	// V1UpdatePowerpoolerConfigWithBody request with any body
	V1UpdatePowerpoolerConfigWithBody(ctx context.Context, ref string, contentType string, body io.Reader, reqEditors ...RequestEditorFn) (*http.Response, error)

	V1UpdatePowerpoolerConfig(ctx context.Context, ref string, body V1UpdatePowerpoolerConfigJSONRequestBody, reqEditors ...RequestEditorFn) (*http.Response, error)
...
func (c *Client) V1GetPowerpoolerConfig(ctx context.Context, ref string, reqEditors ...RequestEditorFn) (*http.Response, error) {
	req, err := NewV1GetPowerpoolerConfigRequest(c.Server, ref)
	if err != nil {
		return nil, err
	}
	req = req.WithContext(ctx)
...
func (c *Client) V1UpdatePowerpoolerConfigWithBody(ctx context.Context, ref string, contentType string, body io.Reader, reqEditors ...RequestEditorFn) (*http.Response, error) {
	req, err := NewV1UpdatePowerpoolerConfigRequestWithBody(c.Server, ref, contentType, body)
	if err != nil {
		return nil, err
	}
	req = req.WithContext(ctx)
...
func (c *Client) V1UpdatePowerpoolerConfig(ctx context.Context, ref string, body V1UpdatePowerpoolerConfigJSONRequestBody, reqEditors ...RequestEditorFn) (*http.Response, error) {
	req, err := NewV1UpdatePowerpoolerConfigRequest(c.Server, ref, body)
	if err != nil {
		return nil, err
	}
	req = req.WithContext(ctx)
...
// NewV1GetPowerpoolerConfigRequest generates requests for V1GetPowerpoolerConfig
func NewV1GetPowerpoolerConfigRequest(server string, ref string) (*http.Request, error) {
	var err error
...
// NewV1UpdatePowerpoolerConfigRequest calls the generic V1UpdatePowerpoolerConfig builder with application/json body
func NewV1UpdatePowerpoolerConfigRequest(server string, ref string, body V1UpdatePowerpoolerConfigJSONRequestBody) (*http.Request, error) {
	var bodyReader io.Reader
	buf, err := json.Marshal(body)
	if err != nil {
		return nil, err
	...
	bodyReader = bytes.NewReader(buf)
	return NewV1UpdatePowerpoolerConfigRequestWithBody(server, ref, "application/json", bodyReader)
}

// NewV1UpdatePowerpoolerConfigRequestWithBody generates requests for V1UpdatePowerpoolerConfig with any type of body
func NewV1UpdatePowerpoolerConfigRequestWithBody(server string, ref string, contentType string, body io.Reader) (*http.Request, error) {
	var err error
...
type ClientWithResponsesInterface interface {
	...
	// V1GetPowerpoolerConfigWithResponse request
	V1GetPowerpoolerConfigWithResponse(ctx context.Context, ref string, reqEditors ...RequestEditorFn) (*V1GetPowerpoolerConfigResponse, error)

	// V1UpdatePowerpoolerConfigWithBodyWithResponse request with any body
	V1UpdatePowerpoolerConfigWithBodyWithResponse(ctx context.Context, ref string, contentType string, body io.Reader, reqEditors ...RequestEditorFn) (*V1UpdatePowerpoolerConfigResponse, error)

	V1UpdatePowerpoolerConfigWithResponse(ctx context.Context, ref string, body V1UpdatePowerpoolerConfigJSONRequestBody, reqEditors ...RequestEditorFn) (*V1UpdatePowerpoolerConfigResponse, error)
...
type V1GetPowerpoolerConfigResponse struct {
	Body         []byte
	HTTPResponse *http.Response
	JSON200      *[]PowerpoolerConfigResponse
}

// Status returns HTTPResponse.Status
func (r V1GetPowerpoolerConfigResponse) Status() string {
	if r.HTTPResponse != nil {
		return r.HTTPResponse.Status
	}
	return http.StatusText(0)
...
// StatusCode returns HTTPResponse.StatusCode
func (r V1GetPowerpoolerConfigResponse) StatusCode() int {
	if r.HTTPResponse != nil {
		return r.HTTPResponse.StatusCode
	}
	return 0
...
type V1UpdatePowerpoolerConfigResponse struct {
	Body         []byte
	HTTPResponse *http.Response
	JSON200      *UpdatePowerpoolerConfigResponse
}

// Status returns HTTPResponse.Status
func (r V1UpdatePowerpoolerConfigResponse) Status() string {
	if r.HTTPResponse != nil {
		return r.HTTPResponse.Status
	}
	return http.StatusText(0)
...
// StatusCode returns HTTPResponse.StatusCode
func (r V1UpdatePowerpoolerConfigResponse) StatusCode() int {
	if r.HTTPResponse != nil {
		return r.HTTPResponse.StatusCode
	}
	return 0
...
// V1GetPowerpoolerConfigWithResponse request returning *V1GetPowerpoolerConfigResponse
func (c *ClientWithResponses) V1GetPowerpoolerConfigWithResponse(ctx context.Context, ref string, reqEditors ...RequestEditorFn) (*V1GetPowerpoolerConfigResponse, error) {
	rsp, err := c.V1GetPowerpoolerConfig(ctx, ref, reqEditors...)
	if err != nil {
		return nil, err
	}
	return ParseV1GetPowerpoolerConfigResponse(rsp)
}

// V1UpdatePowerpoolerConfigWithBodyWithResponse request with arbitrary body returning *V1UpdatePowerpoolerConfigResponse
func (c *ClientWithResponses) V1UpdatePowerpoolerConfigWithBodyWithResponse(ctx context.Context, ref string, contentType string, body io.Reader, reqEditors ...RequestEditorFn) (*V1UpdatePowerpoolerConfigResponse, error) {
	rsp, err := c.V1UpdatePowerpoolerConfigWithBody(ctx, ref, contentType, body, reqEditors...)
	if err != nil {
		return nil, err
	}
	return ParseV1UpdatePowerpoolerConfigResponse(rsp)
}

func (c *ClientWithResponses) V1UpdatePowerpoolerConfigWithResponse(ctx context.Context, ref string, body V1UpdatePowerpoolerConfigJSONRequestBody, reqEditors ...RequestEditorFn) (*V1UpdatePowerpoolerConfigResponse, error) {
	rsp, err := c.V1UpdatePowerpoolerConfig(ctx, ref, body, reqEditors...)
	if err != nil {
		return nil, err
	}
	return ParseV1UpdatePowerpoolerConfigResponse(rsp)
...
// ParseV1GetPowerpoolerConfigResponse parses an HTTP response from a V1GetPowerpoolerConfigWithResponse call
func ParseV1GetPowerpoolerConfigResponse(rsp *http.Response) (*V1GetPowerpoolerConfigResponse, error) {
	bodyBytes, err := io.ReadAll(rsp.Body)
	defer func() { _ = rsp.Body.Close() }()
	if err != nil {
		return nil, err
	...
	response := &V1GetPowerpoolerConfigResponse{
		Body:         bodyBytes,
		HTTPResponse: rsp,
	}
	...
	switch {
	case strings.Contains(rsp.Header.Get("Content-Type"), "json") && rsp.StatusCode == 200:
		var dest []PowerpoolerConfigResponse
		if err := json.Unmarshal(bodyBytes, &dest); err != nil {
			return nil, err
		}
		response.JSON200 = &dest
...
// ParseV1UpdatePowerpoolerConfigResponse parses an HTTP response from a V1UpdatePowerpoolerConfigWithResponse call
func ParseV1UpdatePowerpoolerConfigResponse(rsp *http.Response) (*V1UpdatePowerpoolerConfigResponse, error) {
	bodyBytes, err := io.ReadAll(rsp.Body)
	defer func() { _ = rsp.Body.Close() }()
	if err != nil {
		return nil, err
	...
	response := &V1UpdatePowerpoolerConfigResponse{
		Body:         bodyBytes,
		HTTPResponse: rsp,
	}
	...
	switch {
	case strings.Contains(rsp.Header.Get("Content-Type"), "json") && rsp.StatusCode == 200:
		var dest UpdatePowerpoolerConfigResponse
		if err := json.Unmarshal(bodyBytes, &dest); err != nil {
			return nil, err
		}
		response.JSON200 = &dest
