...
func TestSeedData(t *testing.T) {
	...
	t.Run("throws error on upsert failure", func(t *testing.T) {
		...
		defer conn.Close(t)
		mockSeedHistory(conn).
			Query(testSeed+`;INSERT INTO powerbase_migrations.seed_files(path, hash) VALUES( 'testdata/seed.sql' ,  '61868484fc0ddca2a2022217629a9fd9a4cf1ca479432046290797d6d40ffcc3' ) ON CONFLICT (path) DO UPDATE SET hash = EXCLUDED.hash`).
