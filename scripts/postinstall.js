...
const errGlobal = `Installing Powerbase CLI as a global module is not supported.
Please use one of the supported package managers: https://github.com/skorpland/cli#install-the-cli
`;
...
async function main() {
  ...
  console.info("Installed Powerbase CLI successfully");
}
